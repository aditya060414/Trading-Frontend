  ...
  return (
    <div className="pricing-tab-section">
      ...
      <div className="container-fluid">
        <div className="row justify-content-evenly explaintaion-description">
          <div className="col-5">
            <p className="explaintaion-description-header">
            ...
            <p className="explaintaion-description-header">Stamp charges</p>
            ...
            <p className="explaintaion-description-header">NRI brokerage charges</p>
            <ul>
            ...
            <p className="explaintaion-description-header">Account with debit balance</p>
            ...
            <p className="explaintaion-description-header">Charges for Investor's Protection Fund Trust (IPFT) by NSE</p>
            <ul>
                <li>Equity and Futures - ₹10 per crore + GST of the traded value.</li>
                <li>Options - ₹50 per crore + GST traded value (premium value).</li>
                <li>Currency - ₹0.05 per lakh + GST of turnover for Futures and ₹2 per lakh + GST of premium for Options.</li>
            </ul>
            <p className="explaintaion-description-header">Margin Trading Facility (MTF)</p>
            <ul>
          ...
          <div className="col-5">
            ...
            <p className="explaintaion-description-header">Pledging charges</p>
            <p>₹30 + GST per pledge request per ISIN.</p>
            <p className="explaintaion-description-header">AMC (Account maintenance charges)</p>
            ...
            <p className="explaintaion-description-header">Corporate action order charges</p>
            <p>₹20 plus GST will be charged for OFS / buyback / takeover / delisting orders placed through Console.</p>
            <p className="explaintaion-description-header">Off-market transfer charges</p>
            <p>₹25 per transaction.</p>
            <p className="explaintaion-description-header">Physical CMR request</p>
            <p>First CMR request is free. ₹20 + ₹100 (courier charge) + 18% GST for subsequent requests.</p>
            <p className="explaintaion-description-header">Payment gateway charges</p>
            <p>₹9 + GST (Not levied on transfers done via UPI)</p>
            <p className="explaintaion-description-header">Delayed Payment Charges</p>
            <p>Interest is levied at 18% a year or 0.05% per day on the debit balance in your trading account. <a href="#">Learn more.</a></p>
            <p className="explaintaion-description-header">Trading using 3-in-1 account with block functionality</p>
            <ul>
